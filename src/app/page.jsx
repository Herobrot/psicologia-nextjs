        ...
        <>
            ...
            <main>
                ...
                <div className="comoAgendar">
                    ...
                    <ol>
                        <li>Seleccione el boton de menú en la parte superior.</li><br />
                        <li>Seleccione la opcion "Registrarse" para continuar.</li><br />
                        <li>Ingrese los datos que se le piden, no deje nada vacío.</li><br />
                        <li>¡Listo! Ya tiene una cuenta con la que agendar una cita.</li><br />
                        <li>Puede agendar una cita cuando usted quiera con una cuenta.</li><br />
                    </ol>
                </div>            
            </main>
            <Footer />
